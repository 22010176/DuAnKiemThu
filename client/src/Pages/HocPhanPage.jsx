...
const HocPhanPage = () => {
  ...
  const columns = [
    ...
    { title: 'Số tín chỉ', dataIndex: 'soTinChi', key: 'soTinChi', width: 100, align: 'center', },
    { title: 'Hệ số', dataIndex: 'heSoHocPhan', key: 'heSoHocPhan', width: 80, align: 'center', },
    { title: 'Số tiết', dataIndex: 'soTiet', key: 'soTiet', width: 80, align: 'center', },
    { title: 'Khoa', dataIndex: 'khoa', key: 'khoa', width: 120, },
    {
      title: 'Thao tác', key: 'action', width: 100, align: 'center',
      render: (_, record) => (
        <Space>
          <Button type="link" icon={<EditOutlined />} size="small" onClick={() => handleEdit(record)} style={{ padding: 0 }} />
      ...
      >
        <div style={{ paddingTop: '16px' }}>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <Select placeholder="Chọn khoa" style={{ width: '100%' }} value={khoa} onChange={setKhoa}>
              {khoaList.map(k => <Option key={k} value={k}>{k}</Option>)}
            </Select>
          </div>
          ...
          <div className='mb-5' style={{ flex: 1 }}>
            ...
            <InputNumber min={0.1} max={3.0} step={0.1} placeholder="1.5" style={{ width: '100%' }} value={heSoHocPhan} onChange={setHeSoHocPhan} />
          </div>
          <div className='mb-5' style={{ display: 'flex', gap: 16 }}>
            <div style={{ flex: 1 }}>
              <label style={{ display: 'block', marginBottom: 6, fontWeight: 500, color: '#333' }}>
                Số tín chỉ thực hành <span style={{ color: 'red' }}>*</span>
              </label>
            ...
            <div style={{ flex: 1 }}>
              ...
              <InputNumber disabled min={15} max={150} placeholder="45" style={{ width: '100%' }} value={soTiet} onChange={setSoTiet} />
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: 16 }}>
            <div style={{ flex: 1 }}>
              <label style={{ display: 'block', marginBottom: 6, fontWeight: 500, color: '#333' }}>
                Số tín chỉ lý thuyết<span style={{ color: 'red' }}>*</span>
              </label>
              <InputNumber min={1} max={10} placeholder="3" style={{ width: '100%' }} value={soTinChi} onChange={setSoTinChi} />
            </div>
            {/* <div style={{ flex: 1 }}>
